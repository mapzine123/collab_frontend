...
import { Card, CardContent, CircularProgress, Container, Typography, Chip } from '@mui/material';
...
const Feed = () => {
    ...
    return (
        <Container maxWidth="md" style={{ marginTop: '20px' }}>
            {posts.map((post) => (
                <Card key={post.id} style={{ marginBottom: '20px', height: calculationCardHeight(post.content) + 'px' }}>
                    <CardContent>
